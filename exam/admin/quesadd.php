    	...
    	<form action="" method="post">
    		<table>
    			...
    			<tr>
    				<td>Choice One</td>
    				<td>:</td>
    				<td><input type="text" name="ans1" placeholder="Enter Chice One" required/></td>
    			</tr>
    			<tr>
    				<td>Choice Two</td>
    				<td>:</td>
    				<td><input type="text" name="ans2" placeholder="Enter Chice Two" required/></td>
    			</tr>
    			<tr>
    				<td>Choice Three</td>
    				<td>:</td>
    				<td><input type="text" name="ans3" placeholder="Enter Chice Three" required/></td>
    			</tr>
    			<tr>
    				<td>Choice Four</td>
    				<td>:</td>
    				<td><input type="text" name="ans4" placeholder="Enter Chice Four" required/></td>
    			</tr>
    			<tr>
    				<td>Correct No</td>
    				<td>:</td>
